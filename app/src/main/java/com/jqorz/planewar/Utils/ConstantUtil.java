...
public class ConstantUtil {
    ...
    public static final int SUPPLY_BULLET_INTERVAL_TIME = 25000;//子弹补给间隔时间
     ...
     * 子弹的参数
     */
    public final static int BULLET_POOL_COUNT = 10;//子弹对象的数量
    ...
    public  static int ENEMY_TIME = 800;//敌军飞机出现时间间隔
    public final static int ENEMY_TIME_MUL = 100;//敌军飞机出现时间间隔的递减时间
    public final static int ENEMY_TIME_MIN = 500;//敌军飞机出现最小时间间隔

    public static  int ENEMY_VELOCITY = 5;//敌军飞机的飞行速度
    public static final int ENEMY_VELOCITY_ADD = 1;//敌军飞机的飞行的递增速度
    public static final int ENEMY_VELOCITY_ADD_MAX = 16;//敌军飞机的递增后最大飞行速度
    public static final int ENEMY_VELOCITY_MAX = 20;//敌军飞机的最大飞行速度

    public static final int ENEMY_VELOCITY_AND_TIME = 40000;//敌军飞机的飞行速度的递增时间及敌军飞机出现时间的减少时间
    /**
     * 敌军飞机分数
     */
    public static final int ENEMY_TYPE1_SCORE = 100;//敌军类型1分数
    public static final int ENEMY_TYPE2_SCORE = 300;//敌军类型2分数
    public static final int ENEMY_TYPE3_SCORE = 600;//敌军类型3分数
    /**
     * 飞行速度
     */
     ...
     * 线程休眠时长
     */
    public static final int RUN_THREAD_SPAN = 200;
